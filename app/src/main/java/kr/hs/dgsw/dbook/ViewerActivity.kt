...
class ViewerActivity : AppCompatActivity(), EpubManager.Listener {
    ...
    fun setEpubManager() {
        ...
        val epubDRM = DefaultEpubDRM("")
        epubProvider = EpubFactory.createProvider(this, epubDRM, mSettings)
        epubProvider.run()
        mEpubManager = EpubFactory.createManager(this, "", "", epubProvider, mSettings)
    }

    override fun onParseCompleted() {
        mEpubManager.open(null,  null)
    }
    ...
    override fun onClick(p0: EpubManager?, p1: Int, p2: Int, p3: Int, p4: Int, p5: EpubSettings.AreaType?): Boolean = false
